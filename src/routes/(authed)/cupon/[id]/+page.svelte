	...
	<div class="grid grid-cols-3 gap-12 rounded-lg p-8 place-items-center">
		...
		<div class="flex justify-end">
			<div class="max-w-96 space-y-12 rounded-lg bg-neutral-500/80 p-6">
				...
				<div class="flex items-center justify-between">
					...
					<p class="font-display text-2xl">%{formatCurrency(cupon.porcentaje_descuento)}</p>
				</div>
			</div>
		</div>
		...
		<div class="flex w-full justify-end">
			<div class="max-w-max space-y-2">
				<Button variant="outline" class="max-w-max p-8 font-semibold text-black">Reclamar</Button>
